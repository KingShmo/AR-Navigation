...
const GoogleStyle3DView: React.FC<GoogleStyle3DViewProps> = ({
  ...
  return (
    <div style={{ position: 'relative', height: '100%', width: '100%' }}>
      ...
      </div>      {/* We removed the duplicate AR mode toggle button here since we already have one in the header */}
    </div>
  );
};
...
const EnhancedGoogleStyle3DView: React.FC<GoogleStyle3DViewProps> = (props) => {
  const { direction, isDarkMode, onNavigate } = props;
  ...
  return (
    <GoogleStyle3DView {...props}>
      ...
      <div style={{
        ...
        {/* AR mode toggle is now only in the header of the parent GoogleStyle3DView component */}
    </GoogleStyle3DView>
  );
};
